...
let findProduct = document.querySelector(".products");
let findBut = document.querySelectorAll('button');
findBut.forEach(function(element){
...
function showCategory(category) {
    let productCateg = products[category];
    let markupCateg= "";
    productCateg.forEach(function (product) {
        markupCateg += getProductMarkup(product);
    });
    findProduct.insertAdjacentHTML("afterbegin", markupCateg);    
}
